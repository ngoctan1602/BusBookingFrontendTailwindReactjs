...
const CreateTicketNew = () => {
    ...
    return (
        <div className="w-full h-full">
            <div class='w-full min-h-[500px] text-txt txt-16 bg-bg py-[20px] px-[10px] rounded-md box-shadow-content mb-md' >
                {
                    loadingCreate &&
                ...
                <div class='col-span-3 font-bold text-20 uppercase'>Tạo vé</div>
